...
RSpec.describe MortgageBuddy::Amoratizer do
  ...
  its(:total_interest) { is_expected.to eq(233_137.13) }
  ...
  context 'a bigger loan' do
    ...
    its(:total_interest) { is_expected.to eq(284_773.57) }
  ...
  context 'standard interest rounding' do
    ...
    its(:total_interest) { is_expected.to eq(233_141.28) }
  end
  ...
  context 'increase the payment' do
    ...
    its(:total_interest) { is_expected.to eq(71_691.29) }
  ...
  context 'increase the payment' do
    ...
    its(:total_interest) { is_expected.to eq(68_019.23) }
